...
class Square extends React.Component {
  ...
  render() {
    return (
      <button id={this.props.id} className="squarew" onClick={()=>this.change()}>
        {this.props.current}
      </button>
    );
  }
...
class Board extends React.Component {
  ...
  randomfunc(id,curr, val,flag, score){
        ...
        if(previousVal == val){
          ...
          setTimeout(() => {currentValues[id] = <div>&#10003;</div>;
            currentValues[previousId]=<div>&#10003;</div>;
              this.randomfunc(id, currentValues,val,flag, score);
